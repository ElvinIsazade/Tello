...
const AllAccessories = ({ showInfo }) => {
    ...
    return (
        <div className='AllAccessories_wrapper'>
                                    ...
                                    </div>
                                    {
                                        showCategory ? <div className="accordion_content active">
                                            ...
                                            <div className="samsung_check">
                                                ...
                                                <label className='samsung_text' htmlFor="samsung">LGTone</label>
                                            </div>
                                            <div className="xiaomi_check">
                                                <input type="checkbox" name="xiaomi" id="xiaomi" />
                                                <label htmlFor="xiaomi" className='xiaomi_text'>Technics</label>
                                            </div>
                                            <div className="xiaomi_check">
                                                <input type="checkbox" name="xiaomi" id="xiaomi" />
                                                <label htmlFor="xiaomi" className='xiaomi_text'>Sony</label>
                                            </div>
                                            <div className="xiaomi_check">
                                                <input type="checkbox" name="xiaomi" id="xiaomi" />
                                                <label htmlFor="xiaomi" className='xiaomi_text'>Haylou</label>
                                            </div>
                                            <div className="xiaomi_check">
                                                <input type="checkbox" name="xiaomi" id="xiaomi" />
                                                <label htmlFor="xiaomi" className='xiaomi_text'>Bang</label>
                                            </div>
                                            <div className="xiaomi_check">
                                                <input type="checkbox" name="xiaomi" id="xiaomi" />
                                                <label htmlFor="xiaomi" className='xiaomi_text'>Samsung Buds</label>
                                            </div>
